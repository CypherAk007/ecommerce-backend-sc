...
//    if you want custom status code then use ResponseEntity
    ...
    public ResponseEntity<ExceptionDTO> handleGlobalProductsNotFoundException(Exception e){
        ExceptionDTO exceptionDTO = new ExceptionDTO();
        exceptionDTO.setStatus("Failure");
        exceptionDTO.setMessage(e.getMessage());
        return new ResponseEntity<>(exceptionDTO, HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<ExceptionDTO> handleGlobalUnableToCreateProductException(Exception e){
        ExceptionDTO exceptionDTO = new ExceptionDTO();
        exceptionDTO.setStatus("Failure");
        exceptionDTO.setMessage(e.getMessage());
        return new ResponseEntity<>(exceptionDTO, HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<ExceptionDTO> handleGlobalUnableToUpdateProductException(Exception e){
        ExceptionDTO exceptionDTO = new ExceptionDTO();
        exceptionDTO.setStatus("Failure");
        exceptionDTO.setMessage(e.getMessage());
        return new ResponseEntity<>(exceptionDTO, HttpStatus.NOT_FOUND);
